...
/**
 * @fileoverview left hand pane Connections Detail section
 */

import React, { Component } from 'react';
import { FormGroup, FormControl, ControlLabel, Button } from 'react-bootstrap';

import { FieldGroup, CollapsiblePanel, CheckBoxRight, FormControlRight, MultiInputs, NumberInput, SingleNumberInput } from 'components/controls/form.controls';
...
class ConnectionsDetail extends Component {
    ...
    render() {
        ...
        if (connectionSelected) {
                ...
                <div className={"details"}>
                    ...
                    <div className={"detail detail__container js-port-one"}>
                        ...
                        <FormGroup className={"form--group form-group--collapse"}>
                            <ControlLabel className={"form__label"}><FormattedMessageNoTag
                                id={"polatis.ports.controls-container.type"}/></ControlLabel>
                        ...
                        <FormGroup className={"form-group form-group--collapse"}>
                            <ControlLabel className={"form__label"}><FormattedMessageNoTag
                                id={"polatis.ports.controls-container.connected-to"}/></ControlLabel>
                            <FormControl.Static className={"form__static-text"}>Not connected</FormControl.Static>
                        </FormGroup>

                        <FormGroup className={"form-group form-group--collapse"}>
                            <ControlLabel className={"form__label"}><FormattedMessageNoTag
                                id={"polatis.ports.controls-container.alarm"}/></ControlLabel>
                        ...
                        <div className={"js-stage-one hide"}>
                            ...
                            <FormGroup className={"form-group form-group--collapse"}>
                                <ControlLabel className={"form__label"}><FormattedMessageNoTag
                                    id={"polatis.ports.controls-container.power"}/></ControlLabel>
                                <FormControl.Static className={"form__static-text"}>[x] dBm</FormControl.Static>
                            </FormGroup>

                            <FormGroup className={"form-group form-group--collapse"}>
                                <ControlLabel className={"form__label"}><FormattedMessageNoTag
                                    id={"polatis.ports.controls-container.aps-service"}/></ControlLabel>
                        ...
                        <div className={"js-stage-two hide"}>
                            ...
                            <CollapsiblePanel
                                ...
                                <div>
                                    ...
                                    <FormControlRight id={"alarmControl"} collapse={true}
                                                      label={lib.getFormatMessage("polatis.ports.controls-container.alarm")}>
                                        <FormControl componentClass="select" placeholder="select"
                                                     className={"alarm__alarmControl"}>
                                            <option
                                                value="0">{lib.getFormatMessage("polatis.ports.controls-container.on")}</option>
                                            <option
                                                value="1">{lib.getFormatMessage("polatis.ports.controls-container.off")}</option>
                                        </FormControl>
                                    </FormControlRight>

                                    <MultiInputs id={"thresholdFromToControl"}
                                                 heading={lib.getFormatMessage("polatis.ports.controls-container.threshold")}>
                                        <NumberInput
                                            id={"lowControl"}
                            ...
                            <CollapsiblePanel
                                ...
                                <div>
                                    <FormControlRight id={"attenuationSelect"}
                                                      label={lib.getFormatMessage("polatis.ports.controls-container.attenuation")}>
                                        <FormControl componentClass="select"
                                                     placeholder={lib.getFormatMessage("polatis.forms.placeholder.select")}
                                                     className={"form__select"}
                                                     onChange={this.handleChangeAttenuation}>
                                            <option
                                                value="0">{lib.getFormatMessage("polatis.ports.controls-container.none")}</option>
                                            <option
                                                value="1">{lib.getFormatMessage("polatis.ports.controls-container.absolute")}</option>
                                            <option
                                                value="2">{lib.getFormatMessage("polatis.ports.controls-container.converged-absolute")}</option>
                                            <option
                                                value="3">{lib.getFormatMessage("polatis.ports.controls-container.relative")}</option>
                                        </FormControl>
                                    </FormControlRight>
                                    <SingleNumberInput
                                        id={"levelId"}
                                    ...
                                    <FormGroup className={"form-group js-reference-port hide"}>
                                        <ControlLabel className={"form__label"}><FormattedMessageNoTag
                                            id={"polatis.ports.controls-container.reference-port"}/></ControlLabel>
                                        <FormControl.Static
                                            className={"form__static-text"}>{lib.getFormatMessage("polatis.ports.controls-container.none")}</FormControl.Static>
                                    </FormGroup>
                                </div>
                            </CollapsiblePanel>
                    ...
                    <div className={"details__connection-container"}>
                        ...
                        <Button bsStyle={"primary"} bsSize={uiGeneralConstants.SMALL}
                                className={"details__connection-state"}>{lib.getFormatMessage("polatis.ports.controls-container.disconnect")}</Button>
                    </div>
            ...
            return (
                <Info size={uiGeneralConstants.SMALL} message={"No connection selected"} />
            );
        }
    }
}

export default injectIntl(ConnectionsDetail);